...
<body>
    ...
    <!--<nav class="navbar navbar-expand-lg navbar-dark bg-warning">
        ...
        <div class="collapse navbar-collapse" id="menuderoulant">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                <a class=" h4 nav-link dropdown-toggle px-5 text-success" href="#" id="lienderoulant" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Liens</a>
    ...
    <h1 class="text-center">Administration des liens</h1>
        ...
        <header class="row mt-5">
            ...
            <p class="offset-1 col-md-3"><a href="?p=Ajouter lien" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Ajouter un nouveau lien</a></p>
        </header>
        <div class="row mt-5">
            <div class="col">
